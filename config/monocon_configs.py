...
# Data
_C.DATA = CN()
_C.DATA.ROOT = r'/home/tienli/Desktop/monocon-pytorch/KITTI'                  # KITTI Root
...
_C.MODEL.BACKBONE.NUM_LAYERS = 46
# _C.MODEL.BACKBONE.NUM_LAYERS = 102
...
# Period
_C.PERIOD = CN()
_C.PERIOD.EVAL_PERIOD = 20                    # In Epochs / Set -1 if you don't want validation
_C.PERIOD.LOG_PERIOD = 30                    # In Steps
